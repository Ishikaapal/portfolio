...
export const frontend = [
    ...
    { id: 3, name: "Java Script", url: "skills/js.png" },
    ...
    { id: 8, name: "Python", url: "skills/python.png" },
    { id: 9, name: "Django", url: "skills/django.png" },
    { id: 10, name: "SQL", url: "skills/sql.png" },

];

export const tools = [
    
    { id: 1, name: "Github",  url: "skills/github.png" },
    { id: 2, name: "VS Code",  url: "skills/vscode.png" },
    { id: 3, name: "Visual Studio",  url: "skills/visualstudio.png" },
    { id: 4, name: "Figma",  url: "skills/figma.png" },
...
export const  certificateData = [
  {
    id: 1,
    title:"Full Stack - Meta",
    img: "certificates/Meta Full Stack.png",
  },
  {
    id: 2,
    title:"Python IBM",
    img: "certificates/Python IBM.png",
  },
  {
    id: 3,
    title:"Front End Development Foundation Certificate",
    img: "certificates/Front End Development Foundation Certificate.png",
  },
  {
    id: 4,
    title:"Web Designing Foundation Certificate",
    img: "certificates/Web Designing Foundation Certificate.png",
  },
];